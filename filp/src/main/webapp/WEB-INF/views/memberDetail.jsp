      ...
      <div class="container">
      	<div class="row justify-content-center mb-5">
				<div class="col-md-7 text-center border-primary">
					<h2 class="font-weight-light text-primary">
						회원 <span class="text-warning">정보</span> 변경
					</h2>
        ...
        <div class="row justify-content-center">
          <div class="col-md-7 mb-5"  data-aos="fade">
          	...
          	<form class="p-5 bg-white validate-form" action="memberUpdate.do" onsubmit="return checkpw()" method="post" enctype="multipart/form-data" style="border: 2px solid #30e3ca; border-radius: 20px;">
          	<input type="hidden" name="member_type" id="member_type"  value="${member.member_type}">
 			...
 			<div class="row form-group">              
              ...
              <div class="row form-group">              
                <div class="col-md-12 validate-input">
                  ...
                  <input type="text" id="t_id" class="form-control" name="member_id" value="${member.member_id}" readonly="readonly">
                </div>
    		...
    		<label class="text-black" >프로필등록</label>
    			<div class="row form-group mb-6" style="border: 1px solid #ced4da; border-radius: 10px; ">
					...
					<div class="col-md-6 hidden_input" style="text-align:center;margin-top:15%">
						<p style="color: orange;">업로드할 사진은 가로세로 사이즈가 같은걸로 하자.</p>
						<label for="hidden_file">프로필등록</label>
						<input type="hidden" value="${member.member_profile}" name="old_file">
...
수상내역----------------------------------
              ...
              <div class="row form-group" style="text-align: center;">
                <div class="col-md-12">
                  <input type="submit" value=" 정보수정  " class="btn btn-primary py-2 px-4 text-white" style="width: 100%;">
                  <button type="button" class="btn btn-warning py-2 px-4 text-white" onclick="location.href='mypage.do'" style="margin-top: 5px;width: 100%;">뒤로 가기</button>
                </div>
              </div>
              </form>
          </div>
